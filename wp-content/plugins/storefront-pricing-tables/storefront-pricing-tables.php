 ...
 * Plugin URI:			http://woothemes.com/products/storefront-pricing-tables/
...
final class Storefront_Pricing_Tables {
	...
	public function spt_plugin_links( $links ) {
		$plugin_links = array(
			'<a href="http://support.woothemes.com/">' . __( 'Support', 'storefront-pricing-tables' ) . '</a>',
			'<a href="http://docs.woothemes.com/document/storefront-pricing-tables/">' . __( 'Docs', 'storefront-pricing-tables' ) . '</a>',
		);
	...
	public function spt_pricing_table( $atts, $content = null ) {
		...
		return do_shortcode( '[woocommerce_messages]' ) . '<div class="storefront-pricing-table align-' . esc_attr( $alignment ). ' columns-' . esc_attr( $columns ) . '">' . do_shortcode( $content ) . '</div>';
	}
